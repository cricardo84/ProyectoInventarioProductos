          ...
          <div class="row" id="CategoriaHombre">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                <a href="#"><img class="card-img-top" src="principal/imagenes/img4.jpg" alt=""></a>
                <div class="card-body">
                  <h4 class="card-title">
                    <a href="#">Nike sb</a>
                  </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4" id="CategoriaMujer">
              <div class="card h-100">
                <a href="#"><img class="card-img-top" src="principal/imagenes/img5.jpg" alt=""></a>
                <div class="card-body">
                  <h4 class="card-title">
                    <a href="#">Tacos Zara 2017</a>
                  </h4>
                  <h5>$24.99</h5>
                  <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!</p>
                </div>
